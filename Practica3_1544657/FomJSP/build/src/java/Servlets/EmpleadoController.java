...
public class EmpleadoController extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
            throws ServletException, IOException {
                String nombre = null;
                String sexo = null;
                String fechaNacim = null;
                String email = null;
                String password = null;
                nombre = request.getParameter("txtNombre");
                sexo = request.getParameter("Sexo");
                fechaNacim = request.getParameter("txtFechaNacim");
                email = request.getParameter("txtEmail");
                password = request.getParameter("txtPassword");
                empleado.setNombre(nombre);
                empleado.setSexo(sexo);
                empleado.setFechaNacim(fechaNacim);
                ...
                out.println("<title>Servlet EmpleadoController</title>");            
                out.println("</head>");
                out.println("<body background = Picturs/books.gif>");
                out.printf("<p align=\"Center\">");
                out.println("<a href=\"BienVenido.jsp\">Click para continuar</a>"); 
                out.println("</p>");
                out.println("</body>");
                out.println("</html>");
        }
